...
#
# Ini SATU-SATUNYA tempat SKILL_NORMALIZATION didefinisikan.
# extractor.py TIDAK boleh import dari sini, dan file ini TIDAK
# boleh import apa pun dari extractor.py atau matcher.py —
# supaya tidak ada circular import.
# ============================================================
...
# SOFT SKILLS
#
# Hal yang sifatnya soft-trait/personal. Kalau muncul dalam
# blok Requirements JD, dialihkan ke soft_skills, TIDAK ikut
# menghitung skor required_skill_match.
# ============================================================
